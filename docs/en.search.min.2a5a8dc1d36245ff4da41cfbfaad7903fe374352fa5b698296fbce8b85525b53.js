...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f1e6db7bce94ee950509f15d391554effa3278f16fe3ca5b9b077450ac5cf24a.js',function(){input.required=false;search();});}
