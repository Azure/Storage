...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Storage/flexsearch.min.js');loadScript('/Storage/en.search-data.min.0b99a34c8da773a1d6e8840c1694ea07fe27264f99bbec934a23d0e55268b1e4.js',function(){input.required=false;search();});}
