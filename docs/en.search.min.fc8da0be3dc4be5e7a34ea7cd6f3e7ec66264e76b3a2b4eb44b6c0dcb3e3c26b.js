...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.22a1eb5de6248dece4f0bc79bad10d8e0c29fb7c69f1d66bad4e78ff78d43275.js',function(){input.required=false;search();});}
