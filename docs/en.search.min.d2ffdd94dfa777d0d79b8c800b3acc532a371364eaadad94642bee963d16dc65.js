...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3ef2de986378811072acb83cffa81a01f448dbc11ab0e8ea9af90f91908429cb.js',function(){input.required=false;search();});}
