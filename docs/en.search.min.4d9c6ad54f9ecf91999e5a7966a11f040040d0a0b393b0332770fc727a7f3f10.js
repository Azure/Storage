...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b520993bfe01ba2eedb7474294dd1a28f9a0f36dd83e82e91a3589a311613ebb.js',function(){input.required=false;search();});}
