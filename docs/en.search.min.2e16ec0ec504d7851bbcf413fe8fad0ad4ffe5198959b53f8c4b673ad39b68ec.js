...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6d75e3cd0f027561ef8d339561a39cfd874983bfe137326152094ae24770455a.js',function(){input.required=false;search();});}
